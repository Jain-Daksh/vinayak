        ...
        <div className='newarrival'>
          <div className='container'>
            <div className='row'>
              ...
              <div className='col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 text-new'>
                <h5 className="newarrival-text-h5">NEW ARRIVALS</h5>
                <h4 className="newarrival-text-h5 mt-4">Foldable Table</h4>
                <h3 className="newarrival-text-h6 mt-4"> Laptop Foldable Metal Portable <spam>Laptop Table </spam></h3>
                <br></br>

                <h6 className="newarrival-text-h6">Limited edition</h6>
                <br></br>
                <button type="button" className="btn btn-dark buttonnewarrival mt-3"><a href="https://api.whatsapp.com/send?phone=919694985000" target="_blank">Order Now</a></button>
              </div>
            </div>
          </div>
        </div>
